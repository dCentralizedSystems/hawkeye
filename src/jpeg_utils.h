...
void ground_plane_filter(unsigned char *depth_img, int width, size_t src_size, float view_height, float h_fov, float v_fov, float err_threshold);
void ground_plane_filter_high_depth_inversion(unsigned char *depth_img, int width, size_t src_size, float view_height, float h_fov, float v_fov, float err_threshold);
